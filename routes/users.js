...
const userValidators = [
  ...
  check("password")
    ...
    .withMessage('Your password contain at least 1 lowercase letter, uppercase letter, number, and special character (i.e. "!@#$%^&*")'),
...
router.post('/sign-up', csrfProtection, userValidators, asyncHanlder(async (req, res) => {
